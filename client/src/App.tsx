      ...
      <div className="relative z-10 h-screen w-screen flex items-center justify-end flex-col pb-24">
        <button
          ...
          className={`group relative w-48 h-48 ${
            processing
              ? "from-yellow-500 to-yellow-600 cursor-wait"
              : recording
          ...
          } bg-gradient-to-br text-white font-bold rounded-full text-xl transition-all duration-300 hover:scale-105 active:scale-95 active:shadow-[0_0_20px_rgba(59,130,246,0.3)] overflow-hidden backdrop-blur-sm bg-opacity-80`}
        >
